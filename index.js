...
const startAudio = new Audio("/assets/CHARGE.wav");
const warnAudio = new Audio("/assets/TimeToRun.wav");
const endAudio = new Audio("/assets/BUZZER.wav");
const errorAudio = new Audio("/assets/FOGHORN.wav");
